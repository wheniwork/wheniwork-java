package wiw.internal.org.scribe.model;
...
public class OAuthRequest extends Request
{
  ...
  private static final String WAUTH_PREFIX = "wauth_";
  ...
  {
    if (key.startsWith(OAUTH_PREFIX) || key.startsWith(WAUTH_PREFIX) || key.equals(OAuthConstants.SCOPE))
    {
      return key;
    } 
    else
    {
      throw new IllegalArgumentException(String.format("OAuth parameters must either be '%s' or start with '%s' or '%s'", OAuthConstants.SCOPE, OAUTH_PREFIX, WAUTH_PREFIX));
    }
  }
